...
class EngineView {
    ...
    draw(field, player, enemies, bots, list, leaderBoard, area) {
    ...
    update(field, player, enemies, bots, list, leaderBoard, isShaking, area) {
        ...
        this.draw(field, player, enemies, bots, list, leaderBoard, area);
    }
